 ...
 */
final class Version20241029111400 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article_description ADD CONSTRAINT FK_F7672A41F70C0DA7 FOREIGN KEY (artical_id) REFERENCES artical (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
